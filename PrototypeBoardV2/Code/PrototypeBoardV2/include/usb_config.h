...
#elif defined(PROTOTYPE_BOARD_V2D)

#define USB_PORT D     // [A,C,D] GPIO Port to use with D+, D- and DPU
#define USB_PIN_DP 3   // [0-4] GPIO Number for USB D+ Pin
#define USB_PIN_DM 2   // [0
#define USB_PIN_DPU 4  // [0-7] GPIO for feeding the 1.5k Pull-Up on USB D- Pin; Comment out if not used / tied to 3V3!
...
static const uint8_t config_descriptor[] = {
	...
	9,                        // bLength
	TUSB_DESC_INTERFACE,      // bDescriptorType
	2,                        // bInterfaceNumber  = 1 instead of 0 -- well make it second.
	0,                        // bAlternateSetting
	1,                        // bNumEndpoints
	TUSB_CLASS_HID,           // bInterfaceClass (0x03 = HID)
	HID_SUBCLASS_BOOT,        // bInterfaceSubClass
...
const static struct descriptor_list_struct {
	...
	{0x00022200, keyboard_media_hid_desc, sizeof(keyboard_media_hid_desc)},
